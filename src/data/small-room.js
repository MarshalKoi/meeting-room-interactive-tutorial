export const smallRoomCards = [
  {
    ...
    icon: "Cable",
    steps: [
      "Lấy **cáp HDMI** đặt trong **cánh tủ thứ 2 tính từ bên phải vào**.",
      "Trên touch panel QSYS, chọn **'PHÒNG HỌP NHỎ'** trên màn hình chính.",
      "Chọn kịch bản **'TRÌNH CHIẾU'** rồi ấn **ÁP DỤNG**.",
      "Cắm cáp HDMI vào hộp âm bàn trên bàn họp.",
  ...
  },
  {
    ...
    steps: [
      ...
      "Nhấn **biểu tượng 🔊** trên touch panel để mute/unmute âm lượng tổng.",
